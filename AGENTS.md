...
- **PWA / Web Push** (`docs/pwa-and-push.md`): optional `NEXT_PUBLIC_VAPID_PUBLIC_KEY`, `VAPID_PRIVATE_KEY`, `VAPID_SUBJECT`, `CRON_SECRET`. Without VAPID, install banner and in-app flows still work; OS push and `npm run push:daily` need those vars.
