...
export function MatchBoardStrip() {
  ...
  const renderCard = (card: MatchBoardCard) => (
    <button
  ...
  return (
    <section aria-label="Live and upcoming matches" className="match-board-strip">
      {playedCards.length > 0 ? (
        <div className="match-board-strip-track match-board-strip-track--played" aria-label="Live and recent results">
          {playedCards.map(renderCard)}
        </div>
      ) : null}
      {upcomingCards.length > 0 ? (
        <div className="match-board-strip-track match-board-strip-track--upcoming" aria-label="Upcoming matches">
